...
### musicNoteMapGameKeyBlackKey

映射到游戏的黑键, 对应的 midi 编码

- 1 ~ 5 映射低音 do re fa so la

- 6 ~ 10 映射中音 do re fa so la

- 11 ~ 15 映射高音 do re fa so la
...
// 映射存在黑键的游戏
musicNoteMapGameKeyBlackKey = {
  1: [13, 25, 37, 49], // 把 C1 ~ C4 的 do 的黑键认为是低音
  2: [15, 27, 39, 51],
  3: [18, 30, 42, 54],
  4: [20, 32, 44, 56],
  5: [22, 34, 46, 58], // 低音

  6: [61], // 把 C5 的 do 的黑键认为是中音
  7: [63],
  8: [66],
  9: [68],
  10: [79], // 中音

  11: [73, 85, 97, 109], // 把 C6 ~ C9 的 do 的黑键认为是高音
  12: [75, 87, 99, 111],
  13: [90, 102, 114],
  14: [92, 104, 116],
  15: [94, 106, 118], // 高音
